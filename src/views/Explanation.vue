    ...
    <div class="col">
      ...
      <div class="select-output-section" v-else>
        <el-row class="select-voice-item">
          <el-col :span="5">
            <el-image style="width: 100px; height: 100px;border-radius: 15px;" :src="submitData.image" fit="cover" />
          </el-col>
          <el-col :span="15">
            ...
            <div class="select-btns">
              <div class="btns-plus">
                ...
                <div class="button">
                  ...
                  <div class="unlikefill" v-else @click="submitData.isUnliked = !submitData.isUnliked">
                  </div>
                </div>
                <div class="button">
                  <el-icon size="20" color="#6b7280" style="cursor: pointer;" v-if="!submitData.isCollected"
            ...
            <el-col :span="20">
              ...
              <div class="voice-detail">
                ...
                <el-popover placement="bottom" :width="400" trigger="click">
                  ...
                  <div class="audio-samples">
                    ...
                    <el-card v-for="(sample, index) in voice.sample" :key="index" class="samples-item" shadow="never">
              ...
              <div class="btns">
                ...
                <div class="btns-plus">
                  ...
                  <div class="button">
                    <div class="like" v-if="!voice.isLiked" @click="voice.isLiked = !voice.isLiked; voice.likeCount++;">
                    </div>
